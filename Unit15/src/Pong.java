...
public class Pong extends Canvas implements KeyListener, Runnable
{
	...
	/*public Pong()
	{
		...
		topWall = new Block(0,0,600, 10, Color.WHITE);
   ...
   public void paint(Graphics window)
   {
		...
		if(ball.getX()<=10  + leftWall.getWidth())
		{
			if(ball.getXSpeed()!= 0)
				rightScore++;
			ball.setXSpeed(0);
		...
		graphToBack.drawString("Right Player: " + rightScore, 400, 540);
		graphToBack.drawString("Left Player: " + leftScore, 400, 560);
